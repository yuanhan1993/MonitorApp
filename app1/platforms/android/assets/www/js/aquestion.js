...
function getQuestionCount() {
   ...
   var u_title=$("#utitle").val();
	$
			.ajax({
				url : "http://192.168.43.96:8080/MonitorPortWeb/question/getsearchcount.do",
				type : "post",
				data : {
					"u_title" : u_title,
					"r_flag":r_flag
...
function showQuestion(pageIndex) {
   ...
   var u_title=$("#utitle").val();
	...
	$
			.ajax({
				url : "http://192.168.43.96:8080/MonitorPortWeb/question/showquestion.do",
				type : "post",
				data : {
...
function showQuestionDetail(obj) {
	...
	$.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/question/findbyrid.do",
		type : "post",
		data : {
			"r_id" : obj
		},
...
function delQuestion() {
	...
	var r_id = $(".hideid").val();
	$.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/question/delQuestion.do",
		type : "post",
		data : {
			"r_id" :r_id
		},
...
if(isOk==true){
   $.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/question/addsysq.do",
		type : "post",
		data : {
			"u_id" : u_id,
			"u_title":u_title,
...
if(isOk==true){
   $.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/question/updateq.do",
		type : "post",
		data : {
			"r_answer":r_answer,
			"r_responser":r_responser,
