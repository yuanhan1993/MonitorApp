...
function createPagesByCount() {
	...
	// 查找信息总数
	$.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/message/getcount.do",
		type : "post",
		data : {
			"u_id" : u_id
		},
...
function showVideoList(pageIndex) {
	...
	var u_id=window.localStorage.getItem("uid");
		...
		$
				.ajax({
					url : "http://192.168.43.96:8080/MonitorPortWeb/message/show.do",
					type : "post",
					data : {
						"u_id" : u_id,
...
function showVideoDetail(clickObj) {
	...
	$("#videoSrc").prop('src',
			'http://192.168.43.96:8080/MonitorPortWeb/media/1/' + video);
	//$("#videoSrc").prop('poster',
	//		'http://192.168.43.96:8080/MonitorPortWeb/images/videoimg.png');
}
...
function showHomeVideoDetail(clickObj){
	...
	$("#videoSrc").prop('src',
			'http://192.168.43.96:8080/MonitorPortWeb/media/1/' + video);
	//$("#videoSrc").prop('poster',
	//		'http://192.168.43.96:8080/MonitorPortWeb/media/test.jpg');
}
...
function dealMsg() {
	...
	if (isOk == true) {
		$
				.ajax({
					url : "http://192.168.43.96:8080/MonitorPortWeb/message/deal.do",
					type : "post",
					async : true,
					data : {
						"m_id" : m_id,
