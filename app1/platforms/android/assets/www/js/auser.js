...
function getUserAllCount(){
  ...
  $.ajax({
	url : "http://192.168.43.96:8080/MonitorPortWeb/user/getcount.do",
	type : "post",
	data : {
		"u_checked" : 0,
		"u_phone" : u_phone,
...
function showUserAll(pageIndex){
  ...
  $.ajax({
				url : "http://192.168.43.96:8080/MonitorPortWeb/user/show.do",
				type : "post",
				data : {
...
var u_id=$("#hideid").val();
   $.ajax({
	url : "http://192.168.43.96:8080/MonitorPortWeb/user/agreeadd.do",
	type : "post",
	data : {
		"u_id" : u_id
	},
...
function delUserAll(){
  ...
  var u_id=$(".hideid").val();
    $.ajax({
	url : "http://192.168.43.96:8080/MonitorPortWeb/user/delUserAll.do",
	type : "post",
	data : {
		"u_id" : u_id
	},
...
$.ajax({
	url : "http://192.168.43.96:8080/MonitorPortWeb/user/insertflag.do",
	type : "post",
	data : {
		"u_id" : u_id,
		"u_hasflag":0,
...
function refuse(){
  ...
  u_id=$(".hideid").val();
    $.ajax({
	url : "http://192.168.43.96:8080/MonitorPortWeb/user/deluser.do",
	type : "post",
	data : {
		"u_id" : u_id
	},
...
function showUpdUser(pageIndex){
	$.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/user/showupd.do",
		type : "post",
		data : {
			"currentPage" : pageIndex,
			"pageSize" : 5,
...
function getUserUpCount(){
	  $.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/user/getupcount.do",
		type : "post",
		dataType : "json",
		success : function(result) {
...
function agreeUp(u_id){
	  $.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/user/agreeup.do",
		type : "post",
		data:{"u_id":u_id},
		dataType : "json",
		success : function(result) {
