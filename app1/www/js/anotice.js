...
function getNoticeCount() {
   ...
   var n_flag = $("#selectFlag").val();
	$
			.ajax({
				url : "http://192.168.43.96:8080/MonitorPortWeb/notice/getallcount.do",
				type : "post",
				data : {
					"n_flag" : n_flag,
					"n_title" : n_title
...
function showNotice(pageIndex) {
	...
	$
			.ajax({
				url : "http://192.168.43.96:8080/MonitorPortWeb/notice/search.do",
				type : "post",
				data : {
...
function showNoticeDetail(obj) {
	...
	$.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/notice/findbyid.do",
		type : "post",
		data : {
			"n_id" : obj
		},
...
function delNotice() {
	...
	var n_id = $(".hideid").val();
	$.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/notice/delnotice.do",
		type : "post",
		data : {
			"n_id" :n_id
		},
...
if(isOk==true){
   $.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/notice/updatenotice.do",
		type : "post",
		data : {
			"n_id" : n_id,
			"n_title":n_title,
...
if(isOk==true){
   $.ajax({
		url : "http://192.168.43.96:8080/MonitorPortWeb/notice/addnotice.do",
		type : "post",
		data : {
			"n_title":n_title,
			"n_shortContent":n_shortContent,
