 ...
 function createPage(pageSize, buttons, total) {
     ...
     function showHomeNoticeList(){
    	 $.ajax({
    	        url:"http://192.168.43.96:8080/MonitorPortWeb/notice/show.do",
    	        type:"post",
     ...
     var u_id=window.localStorage.getItem("uid");
       ...
       $.ajax({
		  url:"http://192.168.43.96:8080/MonitorPortWeb/question/findbyuid.do",
		  type:"post",
  ...
  '</div>';
     ...
     function submitQ(){
	  ...
	  $("#qwarning").attr("class","alert alert-danger");
       ...
       $("#qwarning_msg").html("");
       $.ajax({
		  url:"http://192.168.43.96:8080/MonitorPortWeb/question/insertq.do",
		  type:"post",
...
function createPagesCountForNotice(){
 ...
 //
  $.ajax({
	        url:"http://192.168.43.96:8080/MonitorPortWeb/notice/getcount.do",
	        type:"post",
	        data:{"u_flag":1},
	        dataType:"json",
	        success:function(result){
...
function createPagesCountForInfo(){
 ...
 //
  $.ajax({
	        url:"http://192.168.43.96:8080/MonitorPortWeb/question/getcount.do",
	        type:"post",
	       data:{"u_id":u_id},
	        dataType:"json",
	        success:function(result){
